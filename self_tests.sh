...
test3="$ropsir_dir/./ropsir.sh -g $ropsir_dir/data/genome.fasta -a $ropsir_dir/data/genome.gtf -t 32 -pc T -o T -ts YAL005C -pr test.3"
...
test5="$ropsir_dir/./ropsir.sh -g $ropsir_dir/data/genome.fasta -a $ropsir_dir/data/genome.gtf -t 32 -o F -pc T -tg ATGTCAAAAGCTGTCGGTATTGA -pr test.5"
echo "Evaluating test 5! Command is $test5"
eval "$test5"
